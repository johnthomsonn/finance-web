...
exports.deleteTransaction = (req,res) => {
  Transaction.findOneAndDelete({_id : req.transaction._id}, (err, removedTransaction) => {
    ...
    else
    {
      ...
      const newArray = req.user.transactions.filter(transaction => transaction._id.toString() != removedTransaction._id.toString())
